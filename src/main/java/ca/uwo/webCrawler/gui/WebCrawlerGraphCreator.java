...
public class WebCrawlerGraphCreator {
	...
	public WebCrawlerGraphCreator(NodeLink root, Map<String, NodeLink> existing) throws HeadlessException {
	...
	private void createVertices(Map<String, NodeLink> existing) {
	...
	private void createEdges(Map<String, NodeLink> existing) {
		graph.getModel().beginUpdate();
		try {
			for (Map.Entry<String, NodeLink> entry : existing.entrySet()) {
